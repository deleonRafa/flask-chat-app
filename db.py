...
client = MongoClient("mongodb+srv://test:test@cluster0.rnu9g24.mongodb.net/?retryWrites=true&w=majority")
...
def get_messages(room_id, page=0):
    ...
    # message por ser una lista, esta condicion envia la lista en sentido contrario. Esto para que los menajes salgan
